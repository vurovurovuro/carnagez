...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/carnagez)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/carnagez
```

A live public deployment of this template is available at [https://carnagez.templates.workers.dev](https://carnagez.templates.workers.dev)
